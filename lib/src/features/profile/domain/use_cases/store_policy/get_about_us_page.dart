...
class GetAboutUsPageUseCase extends BaseUseCase<String, NoParameters> {
  final BaseProfileRepository profileRepository;

  GetAboutUsPageUseCase(this.profileRepository);

  @override
  Future<Either<Failure, String>> call(NoParameters parameters) async {
    return await profileRepository.getAboutUsPage();
  }
}
